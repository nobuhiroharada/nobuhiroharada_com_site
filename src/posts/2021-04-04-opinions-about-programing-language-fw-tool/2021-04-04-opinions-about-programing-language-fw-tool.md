...
何年も前から jQuery を外すことに精を出しており、とうとう BootStrap5 でも完全に外される予定だ
...
もう ob-c のみで動いてるアプリはないよね？ライブラリは(ry
...
フレームワークを使ってないのでそれぞれの DB の差分を吸収してくれなかったり、カラム名に PosgreSQL の予約語が使われていたりと、というよりなぜ MySQL と PostgreSQL を併(ry、

結局メソッド内で A 向けのデータを取り行くのか、B 向けのデータを取り行くのか分岐し、クエリを分けるという非常によろしくない対応をすることに
