...
gatsby build コマンドでこけており、Node のバージョンは 12系以上が必要なのに、10系でビルドしてる、と怒られています

Node のバージョンを設定した覚えがなかったので、ググっていますと、下記投稿を見つけました

<br>

__Node.js version on Netlify outdated__
...
__Site settings > Build & deploy > Environment > Environment variables__
